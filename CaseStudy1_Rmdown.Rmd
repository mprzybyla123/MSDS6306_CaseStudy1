...
ggsave(filename = "HighIncomeNonOECD.png", plot = HighIncomeNoneOECDPlot) 
```
...
ggsave(filename = "HighIncomeOECD.png", plot = HighIncomeOECDPlot)
```
...
ggsave(filename = "LowIncome.png", plot = LowIncomePlot)
...
ggsave(filename = "LowerMiddleIncome.png", plot = LowerMiddleIncomePlot)
```
...
ggsave(filename = "UpperMiddleIncome.png", plot = UpperMiddleIncomePlot)
